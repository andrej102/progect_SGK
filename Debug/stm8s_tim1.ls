 ...
 770                     ; 180     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM)) | 
 770                     ; 181                             (uint8_t)TIM1_OCMode);
 772  01c1 c65258        	ld	a,21080
 773  01c4 a48f          	and	a,#143
 774  01c6 1a04          	or	a,(OFST+1,sp)
 775  01c8 c75258        	ld	21080,a
 776                     ; 184     TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS1 | TIM1_OISR_OIS1N));
 778  01cb c6526f        	ld	a,21103
 779  01ce a4fc          	and	a,#252
 780  01d0 c7526f        	ld	21103,a
 781                     ; 186     TIM1->OISR |= (uint8_t)((uint8_t)( TIM1_OCIdleState & TIM1_OISR_OIS1 ) | 
 781                     ; 187                             (uint8_t)( TIM1_OCNIdleState & TIM1_OISR_OIS1N ));
 ...
 791                     ; 190     TIM1->CCR1H = (uint8_t)(TIM1_Pulse >> 8);
 793  01e5 7b09          	ld	a,(OFST+6,sp)
 794  01e7 c75265        	ld	21093,a
 795                     ; 191     TIM1->CCR1L = (uint8_t)(TIM1_Pulse);
 797  01ea 7b0a          	ld	a,(OFST+7,sp)
 798  01ec c75266        	ld	21094,a
 799                     ; 192 }
 802  01ef 5b05          	addw	sp,#5
 803  01f1 81            	ret	
 906                     ; 213 void TIM1_OC2Init(TIM1_OCMode_TypeDef TIM1_OCMode,
 906                     ; 214                   TIM1_OutputState_TypeDef TIM1_OutputState,
 906                     ; 215                   TIM1_OutputNState_TypeDef TIM1_OutputNState,
 906                     ; 216                   uint16_t TIM1_Pulse,
 906                     ; 217                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
 906                     ; 218                   TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity,
 906                     ; 219                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState,
 906                     ; 220                   TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
 906                     ; 221 {
 907                     	switch	.text
 ...
 915                     ; 223     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
 917  01f5 9e            	ld	a,xh
 918  01f6 4d            	tnz	a
...
1003  0278               L061:
1004                     ; 228     assert_param(IS_TIM1_OCIDLE_STATE_OK(TIM1_OCIdleState));
...
1019  0290               L071:
1020                     ; 229     assert_param(IS_TIM1_OCNIDLE_STATE_OK(TIM1_OCNIdleState));
...
1035  02a8               L002:
1036                     ; 233     TIM1->CCER1 &= (uint8_t)(~( TIM1_CCER1_CC2E | TIM1_CCER1_CC2NE | 
1036                     ; 234                                 TIM1_CCER1_CC2P | TIM1_CCER1_CC2NP));
1038  02a8 c6525c        	ld	a,21084
1039  02ab a40f          	and	a,#15
1040  02ad c7525c        	ld	21084,a
1041                     ; 238     TIM1->CCER1 |= (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER1_CC2E  ) | 
1041                     ; 239                              (uint8_t)(TIM1_OutputNState & TIM1_CCER1_CC2NE )) | 
1041                     ; 240                              (uint8_t)((uint8_t)(TIM1_OCPolarity  & TIM1_CCER1_CC2P  ) | 
1041                     ; 241                              (uint8_t)(TIM1_OCNPolarity & TIM1_CCER1_CC2NP )));
...
1059                     ; 244     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM)) | 
1059                     ; 245                              (uint8_t)TIM1_OCMode);
1061  02d2 c65259        	ld	a,21081
1062  02d5 a48f          	and	a,#143
1063  02d7 1a04          	or	a,(OFST+1,sp)
1064  02d9 c75259        	ld	21081,a
1065                     ; 248     TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS2 | TIM1_OISR_OIS2N));
1067  02dc c6526f        	ld	a,21103
1068  02df a4f3          	and	a,#243
1069  02e1 c7526f        	ld	21103,a
1070                     ; 250     TIM1->OISR |= (uint8_t)((uint8_t)(TIM1_OISR_OIS2 & TIM1_OCIdleState) | 
1070                     ; 251                             (uint8_t)(TIM1_OISR_OIS2N & TIM1_OCNIdleState));
...
1080                     ; 254     TIM1->CCR2H = (uint8_t)(TIM1_Pulse >> 8);
1082  02f6 7b09          	ld	a,(OFST+6,sp)
1083  02f8 c75267        	ld	21095,a
1084                     ; 255     TIM1->CCR2L = (uint8_t)(TIM1_Pulse);
1086  02fb 7b0a          	ld	a,(OFST+7,sp)
1087  02fd c75268        	ld	21096,a
1088                     ; 257 }
1091  0300 5b05          	addw	sp,#5
1092  0302 81            	ret	
1195                     ; 278 void TIM1_OC3Init(TIM1_OCMode_TypeDef TIM1_OCMode,
1195                     ; 279                   TIM1_OutputState_TypeDef TIM1_OutputState,
1195                     ; 280                   TIM1_OutputNState_TypeDef TIM1_OutputNState,
1195                     ; 281                   uint16_t TIM1_Pulse,
1195                     ; 282                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
1195                     ; 283                   TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity,
1195                     ; 284                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState,
1195                     ; 285                   TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
1195                     ; 286 {
1196                     	switch	.text
...
1204                     ; 288     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
...
1292  0389               L252:
1293                     ; 293     assert_param(IS_TIM1_OCIDLE_STATE_OK(TIM1_OCIdleState));
...
1308  03a1               L262:
1309                     ; 294     assert_param(IS_TIM1_OCNIDLE_STATE_OK(TIM1_OCNIdleState));
...
1324  03b9               L272:
1325                     ; 298     TIM1->CCER2 &= (uint8_t)(~( TIM1_CCER2_CC3E | TIM1_CCER2_CC3NE | 
1325                     ; 299                                 TIM1_CCER2_CC3P | TIM1_CCER2_CC3NP));
1327  03b9 c6525d        	ld	a,21085
1328  03bc a4f0          	and	a,#240
1329  03be c7525d        	ld	21085,a
1330                     ; 302     TIM1->CCER2 |= (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState  & TIM1_CCER2_CC3E   ) |
1330                     ; 303                              (uint8_t)(TIM1_OutputNState & TIM1_CCER2_CC3NE  )) | 
1330                     ; 304                              (uint8_t)((uint8_t)(TIM1_OCPolarity   & TIM1_CCER2_CC3P   ) | 
1330                     ; 305                              (uint8_t)(TIM1_OCNPolarity  & TIM1_CCER2_CC3NP  )));
...
1348                     ; 308     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM)) | 
1348                     ; 309                              (uint8_t)TIM1_OCMode);
1350  03e3 c6525a        	ld	a,21082
1351  03e6 a48f          	and	a,#143
1352  03e8 1a04          	or	a,(OFST+1,sp)
1353  03ea c7525a        	ld	21082,a
1354                     ; 312     TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS3 | TIM1_OISR_OIS3N));
1356  03ed c6526f        	ld	a,21103
1357  03f0 a4cf          	and	a,#207
1358  03f2 c7526f        	ld	21103,a
1359                     ; 314     TIM1->OISR |= (uint8_t)((uint8_t)(TIM1_OISR_OIS3 & TIM1_OCIdleState) | 
1359                     ; 315                             (uint8_t)(TIM1_OISR_OIS3N & TIM1_OCNIdleState));
...
1369                     ; 318     TIM1->CCR3H = (uint8_t)(TIM1_Pulse >> 8);
1371  0407 7b09          	ld	a,(OFST+6,sp)
1372  0409 c75269        	ld	21097,a
1373                     ; 319     TIM1->CCR3L = (uint8_t)(TIM1_Pulse);
1375  040c 7b0a          	ld	a,(OFST+7,sp)
1376  040e c7526a        	ld	21098,a
1377                     ; 321 }
1380  0411 5b05          	addw	sp,#5
1381  0413 81            	ret	
1454                     ; 336 void TIM1_OC4Init(TIM1_OCMode_TypeDef TIM1_OCMode,
1454                     ; 337                   TIM1_OutputState_TypeDef TIM1_OutputState,
1454                     ; 338                   uint16_t TIM1_Pulse,
1454                     ; 339                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
1454                     ; 340                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState)
1454                     ; 341 {
1455                     	switch	.text
...
1463                     ; 343     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
...
1521  046d               L423:
1522                     ; 346     assert_param(IS_TIM1_OCIDLE_STATE_OK(TIM1_OCIdleState));
...
1537  0485               L433:
1538                     ; 349     TIM1->CCER2 &= (uint8_t)(~(TIM1_CCER2_CC4E | TIM1_CCER2_CC4P));
1540  0485 c6525d        	ld	a,21085
1541  0488 a4cf          	and	a,#207
1542  048a c7525d        	ld	21085,a
1543                     ; 351     TIM1->CCER2 |= (uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER2_CC4E ) |  
1543                     ; 352                              (uint8_t)(TIM1_OCPolarity  & TIM1_CCER2_CC4P ));
...
1553                     ; 355     TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) | 
1553                     ; 356                             TIM1_OCMode);
1555  049f c6525b        	ld	a,21083
1556  04a2 a48f          	and	a,#143
1557  04a4 1a02          	or	a,(OFST+1,sp)
1558  04a6 c7525b        	ld	21083,a
1559                     ; 359     if (TIM1_OCIdleState != TIM1_OCIDLESTATE_RESET)
1561  04a9 7b09          	ld	a,(OFST+8,sp)
1562  04ab 270a          	jreq	L124
1563                     ; 361         TIM1->OISR |= (uint8_t)(~TIM1_CCER2_CC4P);
1565  04ad c6526f        	ld	a,21103
1566  04b0 aadf          	or	a,#223
1567  04b2 c7526f        	ld	21103,a
1569  04b5 2004          	jra	L324
1570  04b7               L124:
1571                     ; 365         TIM1->OISR &= (uint8_t)(~TIM1_OISR_OIS4);
1573  04b7 721d526f      	bres	21103,#6
1574  04bb               L324:
1575                     ; 369     TIM1->CCR4H = (uint8_t)(TIM1_Pulse >> 8);
1577  04bb 7b06          	ld	a,(OFST+5,sp)
1578  04bd c7526b        	ld	21099,a
1579                     ; 370     TIM1->CCR4L = (uint8_t)(TIM1_Pulse);
1581  04c0 7b07          	ld	a,(OFST+6,sp)
1582  04c2 c7526c        	ld	21100,a
1583                     ; 372 }
1586  04c5 5b03          	addw	sp,#3
1587  04c7 81            	ret	
1791                     ; 387 void TIM1_BDTRConfig(TIM1_OSSIState_TypeDef TIM1_OSSIState,
1791                     ; 388                      TIM1_LockLevel_TypeDef TIM1_LockLevel,
1791                     ; 389                      uint8_t TIM1_DeadTime,
1791                     ; 390                      TIM1_BreakState_TypeDef TIM1_Break,
1791                     ; 391                      TIM1_BreakPolarity_TypeDef TIM1_BreakPolarity,
1791                     ; 392                      TIM1_AutomaticOutput_TypeDef TIM1_AutomaticOutput)
1791                     ; 393 {
1792                     	switch	.text
...
1800                     ; 395     assert_param(IS_TIM1_OSSI_STATE_OK(TIM1_OSSIState));
...
1816  04e1               L643:
1817                     ; 396     assert_param(IS_TIM1_LOCK_LEVEL_OK(TIM1_LockLevel));
...
1835  04ff               L653:
1836                     ; 397     assert_param(IS_TIM1_BREAK_STATE_OK(TIM1_Break));
...
1866  052d               L673:
1867                     ; 399     assert_param(IS_TIM1_AUTOMATIC_OUTPUT_STATE_OK(TIM1_AutomaticOutput));
...
1882  0545               L604:
1883                     ; 401     TIM1->DTR = (uint8_t)(TIM1_DeadTime);
1885  0545 7b06          	ld	a,(OFST+5,sp)
1886  0547 c7526e        	ld	21102,a
1887                     ; 405     TIM1->BKR  =  (uint8_t)((uint8_t)(TIM1_OSSIState | (uint8_t)TIM1_LockLevel)  | 
1887                     ; 406                             (uint8_t)((uint8_t)(TIM1_Break | (uint8_t)TIM1_BreakPolarity)  | 
1887                     ; 407                             (uint8_t)TIM1_AutomaticOutput));
...
2110                     ; 431     assert_param(IS_TIM1_CHANNEL_OK(TIM1_Channel));
...
2132  057f               L024:
2133                     ; 432     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
2135  057f 7b02          	ld	a,(OFST+2,sp)
2136  0581 2711          	jreq	L034
2137  0583 4a            	dec	a
2138  0584 270e          	jreq	L034
2139  0586 ae01b0        	ldw	x,#432
...
2147  0594               L034:
2148                     ; 433     assert_param(IS_TIM1_IC_SELECTION_OK(TIM1_ICSelection));
...
2165  05b0               L044:
2166                     ; 434     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_ICPrescaler));
...
2184  05ce               L054:
2185                     ; 435     assert_param(IS_TIM1_IC_FILTER_OK(TIM1_ICFilter));
2187  05ce 7b07          	ld	a,(OFST+7,sp)
2188  05d0 a110          	cp	a,#16
2189  05d2 250e          	jrult	L654
2190  05d4 ae01b3        	ldw	x,#435
...
2198  05e2               L654:
2199                     ; 437     if (TIM1_Channel == TIM1_CHANNEL_1)
2201  05e2 7b01          	ld	a,(OFST+1,sp)
2202  05e4 2614          	jrne	L746
2203                     ; 440         TI1_Config((uint8_t)TIM1_ICPolarity,
2203                     ; 441                    (uint8_t)TIM1_ICSelection,
2203                     ; 442                    (uint8_t)TIM1_ICFilter);
...
2213  05f2 84            	pop	a
2214                     ; 444         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
2216  05f3 7b06          	ld	a,(OFST+6,sp)
2217  05f5 cd0ff8        	call	_TIM1_SetIC1Prescaler
2220  05f8 2042          	jra	L156
2221  05fa               L746:
2222                     ; 446     else if (TIM1_Channel == TIM1_CHANNEL_2)
2224  05fa a101          	cp	a,#1
2225  05fc 2614          	jrne	L356
2226                     ; 449         TI2_Config((uint8_t)TIM1_ICPolarity,
2226                     ; 450                    (uint8_t)TIM1_ICSelection,
2226                     ; 451                    (uint8_t)TIM1_ICFilter);
...
2236  060a 84            	pop	a
2237                     ; 453         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
2239  060b 7b06          	ld	a,(OFST+6,sp)
2240  060d cd1022        	call	_TIM1_SetIC2Prescaler
2243  0610 202a          	jra	L156
2244  0612               L356:
2245                     ; 455     else if (TIM1_Channel == TIM1_CHANNEL_3)
2247  0612 a102          	cp	a,#2
2248  0614 2614          	jrne	L756
2249                     ; 458         TI3_Config((uint8_t)TIM1_ICPolarity,
2249                     ; 459                    (uint8_t)TIM1_ICSelection,
2249                     ; 460                    (uint8_t)TIM1_ICFilter);
...
2259  0622 84            	pop	a
2260                     ; 462         TIM1_SetIC3Prescaler(TIM1_ICPrescaler);
2262  0623 7b06          	ld	a,(OFST+6,sp)
2263  0625 cd104c        	call	_TIM1_SetIC3Prescaler
2266  0628 2012          	jra	L156
2267  062a               L756:
2268                     ; 467         TI4_Config((uint8_t)TIM1_ICPolarity,
2268                     ; 468                    (uint8_t)TIM1_ICSelection,
2268                     ; 469                    (uint8_t)TIM1_ICFilter);
...
2278  0636 84            	pop	a
2279                     ; 471         TIM1_SetIC4Prescaler(TIM1_ICPrescaler);
...
2288  063c 85            	popw	x
2289  063d 81            	ret	
2380                     ; 490 void TIM1_PWMIConfig(TIM1_Channel_TypeDef TIM1_Channel,
2380                     ; 491                      TIM1_ICPolarity_TypeDef TIM1_ICPolarity,
2380                     ; 492                      TIM1_ICSelection_TypeDef TIM1_ICSelection,
2380                     ; 493                      TIM1_ICPSC_TypeDef TIM1_ICPrescaler,
2380                     ; 494                      uint8_t TIM1_ICFilter)
2380                     ; 495 {
2381                     	switch	.text
...
2389                     ; 496     uint8_t icpolarity = TIM1_ICPOLARITY_RISING;
2391                     ; 497     uint8_t icselection = TIM1_ICSELECTION_DIRECTTI;
2393                     ; 500     assert_param(IS_TIM1_PWMI_CHANNEL_OK(TIM1_Channel));
...
2409  0656               L015:
2410                     ; 501     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
2412  0656 7b04          	ld	a,(OFST+2,sp)
2413  0658 2711          	jreq	L025
2414  065a 4a            	dec	a
2415  065b 270e          	jreq	L025
2416  065d ae01f5        	ldw	x,#501
...
2424  066b               L025:
2425                     ; 502     assert_param(IS_TIM1_IC_SELECTION_OK(TIM1_ICSelection));
...
2442  0687               L035:
2443                     ; 503     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_ICPrescaler));
...
2461  06a5               L045:
2462                     ; 506     if (TIM1_ICPolarity != TIM1_ICPOLARITY_FALLING)
2464  06a5 7b04          	ld	a,(OFST+2,sp)
2465  06a7 4a            	dec	a
2466  06a8 2702          	jreq	L327
2467                     ; 508         icpolarity = TIM1_ICPOLARITY_FALLING;
2469  06aa a601          	ld	a,#1
2471  06ac               L327:
2472                     ; 512         icpolarity = TIM1_ICPOLARITY_RISING;
2474  06ac 6b01          	ld	(OFST-1,sp),a
2475                     ; 516     if (TIM1_ICSelection == TIM1_ICSELECTION_DIRECTTI)
2477  06ae 7b07          	ld	a,(OFST+5,sp)
2478  06b0 4a            	dec	a
2479  06b1 2604          	jrne	L727
2480                     ; 518         icselection = TIM1_ICSELECTION_INDIRECTTI;
2482  06b3 a602          	ld	a,#2
2484  06b5 2002          	jra	L137
2485  06b7               L727:
2486                     ; 522         icselection = TIM1_ICSELECTION_DIRECTTI;
2488  06b7 a601          	ld	a,#1
2489  06b9               L137:
2490  06b9 6b02          	ld	(OFST+0,sp),a
2491                     ; 525     if (TIM1_Channel == TIM1_CHANNEL_1)
2493  06bb 7b03          	ld	a,(OFST+1,sp)
2494  06bd 2626          	jrne	L337
2495                     ; 528         TI1_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSelection,
2495                     ; 529                    (uint8_t)TIM1_ICFilter);
...
2505  06cb 84            	pop	a
2506                     ; 532         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
2508  06cc 7b08          	ld	a,(OFST+6,sp)
2509  06ce cd0ff8        	call	_TIM1_SetIC1Prescaler
2511                     ; 535         TI2_Config(icpolarity, icselection, TIM1_ICFilter);
...
2521  06dd 84            	pop	a
2522                     ; 538         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
2524  06de 7b08          	ld	a,(OFST+6,sp)
2525  06e0 cd1022        	call	_TIM1_SetIC2Prescaler
2528  06e3 2024          	jra	L537
2529  06e5               L337:
2530                     ; 543         TI2_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSelection,
2530                     ; 544                    (uint8_t)TIM1_ICFilter);
...
2540  06f1 84            	pop	a
2541                     ; 547         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
2543  06f2 7b08          	ld	a,(OFST+6,sp)
2544  06f4 cd1022        	call	_TIM1_SetIC2Prescaler
2546                     ; 550         TI1_Config(icpolarity, icselection, TIM1_ICFilter);
...
2556  0703 84            	pop	a
2557                     ; 553         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
...
2567  070b 81            	ret	
2623                     ; 563 void TIM1_Cmd(FunctionalState NewState)
2623                     ; 564 {
2624                     	switch	.text
2625  070c               _TIM1_Cmd:
2627  070c 88            	push	a
2628       00000000      OFST:	set	0
2631                     ; 566     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2633  070d 4d            	tnz	a
2634  070e 2711          	jreq	L275
2635  0710 4a            	dec	a
2636  0711 270e          	jreq	L275
2637  0713 ae0236        	ldw	x,#566
...
2871  0769               L416:
2872                     ; 623     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2874  0769 7b02          	ld	a,(OFST+2,sp)
2875  076b 2711          	jreq	L426
2876  076d 4a            	dec	a
2877  076e 270e          	jreq	L426
2878  0770 ae026f        	ldw	x,#623
...
2908  0792 85            	popw	x
2909  0793 81            	ret	
2933                     ; 642 void TIM1_InternalClockConfig(void)
2933                     ; 643 {
2934                     	switch	.text
2935  0794               _TIM1_InternalClockConfig:
2939                     ; 645     TIM1->SMCR &= (uint8_t)(~TIM1_SMCR_SMS);
2941  0794 c65252        	ld	a,21074
2942  0797 a4f8          	and	a,#248
2943  0799 c75252        	ld	21074,a
2944                     ; 646 }
2947  079c 81            	ret	
3063                     ; 664 void TIM1_ETRClockMode1Config(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
3063                     ; 665                               TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
3063                     ; 666                               uint8_t ExtTRGFilter)
3063                     ; 667 {
3064                     	switch	.text
3065  079d               _TIM1_ETRClockMode1Config:
3067  079d 89            	pushw	x
3068       00000000      OFST:	set	0
3071                     ; 669     assert_param(IS_TIM1_EXT_PRESCALER_OK(TIM1_ExtTRGPrescaler));
...
3093  07bf               L046:
3094                     ; 670     assert_param(IS_TIM1_EXT_POLARITY_OK(TIM1_ExtTRGPolarity));
...
3109  07d7               L056:
3110                     ; 673     TIM1_ETRConfig(TIM1_ExtTRGPrescaler, TIM1_ExtTRGPolarity, ExtTRGFilter);
...
3120  07e2 84            	pop	a
3121                     ; 676     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~(uint8_t)(TIM1_SMCR_SMS | TIM1_SMCR_TS )))
3121                     ; 677                            | (uint8_t)((uint8_t)TIM1_SLAVEMODE_EXTERNAL1 | TIM1_TS_ETRF ));
...
3129  07eb 85            	popw	x
3130  07ec 81            	ret	
3187                     ; 696 void TIM1_ETRClockMode2Config(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
3187                     ; 697                               TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
3187                     ; 698                               uint8_t ExtTRGFilter)
3187                     ; 699 {
3188                     	switch	.text
3189  07ed               _TIM1_ETRClockMode2Config:
3191  07ed 89            	pushw	x
3192       00000000      OFST:	set	0
3195                     ; 701     assert_param(IS_TIM1_EXT_PRESCALER_OK(TIM1_ExtTRGPrescaler));
...
3217  080f               L466:
3218                     ; 702     assert_param(IS_TIM1_EXT_POLARITY_OK(TIM1_ExtTRGPolarity));
...
3233  0827               L476:
3234                     ; 705     TIM1_ETRConfig(TIM1_ExtTRGPrescaler, TIM1_ExtTRGPolarity, ExtTRGFilter);
...
3245  0836 84            	pop	a
3246                     ; 708     TIM1->ETR |= TIM1_ETR_ECE;
3248                     ; 709 }
3251  0837 85            	popw	x
3252  0838 81            	ret	
3307                     ; 727 void TIM1_ETRConfig(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
3307                     ; 728                     TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
3307                     ; 729                     uint8_t ExtTRGFilter)
3307                     ; 730 {
3308                     	switch	.text
3309  0839               _TIM1_ETRConfig:
3311  0839 89            	pushw	x
3312       00000000      OFST:	set	0
3315                     ; 732     assert_param(IS_TIM1_EXT_TRG_FILTER_OK(ExtTRGFilter));
3317  083a 7b05          	ld	a,(OFST+5,sp)
3318  083c a110          	cp	a,#16
3319  083e 250e          	jrult	L607
3320  0840 ae02dc        	ldw	x,#732
...
3328  084e               L607:
3329                     ; 734     TIM1->ETR |= (uint8_t)((uint8_t)(TIM1_ExtTRGPrescaler | (uint8_t)TIM1_ExtTRGPolarity )|
3329                     ; 735                       (uint8_t)ExtTRGFilter );
...
3339  085a 85            	popw	x
3340  085b 81            	ret	
3428                     ; 753 void TIM1_TIxExternalClockConfig(TIM1_TIxExternalCLK1Source_TypeDef TIM1_TIxExternalCLKSource,
3428                     ; 754                                  TIM1_ICPolarity_TypeDef TIM1_ICPolarity,
3428                     ; 755                                  uint8_t ICFilter)
3428                     ; 756 {
3429                     	switch	.text
3430  085c               _TIM1_TIxExternalClockConfig:
3432  085c 89            	pushw	x
3433       00000000      OFST:	set	0
3436                     ; 758     assert_param(IS_TIM1_TIXCLK_SOURCE_OK(TIM1_TIxExternalCLKSource));
...
3455  087a               L027:
3456                     ; 759     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
3458  087a 7b02          	ld	a,(OFST+2,sp)
3459  087c 2711          	jreq	L037
3460  087e 4a            	dec	a
3461  087f 270e          	jreq	L037
3462  0881 ae02f7        	ldw	x,#759
...
3470  088f               L037:
3471                     ; 760     assert_param(IS_TIM1_IC_FILTER_OK(ICFilter));
3473  088f 7b05          	ld	a,(OFST+5,sp)
3474  0891 a110          	cp	a,#16
3475  0893 250e          	jrult	L637
3476  0895 ae02f8        	ldw	x,#760
...
3484  08a3               L637:
3485                     ; 763     if (TIM1_TIxExternalCLKSource == TIM1_TIXEXTERNALCLK1SOURCE_TI2)
3487  08a3 7b01          	ld	a,(OFST+1,sp)
3488  08a5 a160          	cp	a,#96
3489  08a7 260e          	jrne	L3521
3490                     ; 765         TI2_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSELECTION_DIRECTTI, (uint8_t)ICFilter);
...
3501  08b7               L3521:
3502                     ; 769         TI1_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSELECTION_DIRECTTI, (uint8_t)ICFilter);
...
3511  08c3               L5521:
3512  08c3 84            	pop	a
3513                     ; 773     TIM1_SelectInputTrigger((TIM1_TS_TypeDef)TIM1_TIxExternalCLKSource);
3515  08c4 7b01          	ld	a,(OFST+1,sp)
3516  08c6 ad0a          	call	_TIM1_SelectInputTrigger
3518                     ; 776     TIM1->SMCR |= (uint8_t)(TIM1_SLAVEMODE_EXTERNAL1);
...
3526  08d0 85            	popw	x
3527  08d1 81            	ret	
3613                     ; 789 void TIM1_SelectInputTrigger(TIM1_TS_TypeDef TIM1_InputTriggerSource)
3613                     ; 790 {
3614                     	switch	.text
3615  08d2               _TIM1_SelectInputTrigger:
3617  08d2 88            	push	a
3618       00000000      OFST:	set	0
3621                     ; 792     assert_param(IS_TIM1_TRIGGER_SELECTION_OK(TIM1_InputTriggerSource));
...
3643  08f8               L657:
3644                     ; 795     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~TIM1_SMCR_TS)) | (uint8_t)TIM1_InputTriggerSource);
...
3653  0902 84            	pop	a
3654  0903 81            	ret	
3691                     ; 806 void TIM1_UpdateDisableConfig(FunctionalState NewState)
3691                     ; 807 {
3692                     	switch	.text
3693  0904               _TIM1_UpdateDisableConfig:
3695  0904 88            	push	a
3696       00000000      OFST:	set	0
3699                     ; 809     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
3701  0905 4d            	tnz	a
3702  0906 2711          	jreq	L077
3703  0908 4a            	dec	a
3704  0909 270e          	jreq	L077
3705  090b ae0329        	ldw	x,#809
...
3713  0919               L077:
3714                     ; 812     if (NewState != DISABLE)
3716  0919 7b01          	ld	a,(OFST+1,sp)
3717  091b 2706          	jreq	L3331
3718                     ; 814         TIM1->CR1 |= TIM1_CR1_UDIS;
3720  091d 72125250      	bset	21072,#1
3722  0921 2004          	jra	L5331
3723  0923               L3331:
3724                     ; 818         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_UDIS);
3726  0923 72135250      	bres	21072,#1
3727  0927               L5331:
3728                     ; 820 }
3731  0927 84            	pop	a
3732  0928 81            	ret	
3791                     ; 830 void TIM1_UpdateRequestConfig(TIM1_UpdateSource_TypeDef TIM1_UpdateSource)
3791                     ; 831 {
3792                     	switch	.text
3793  0929               _TIM1_UpdateRequestConfig:
3795  0929 88            	push	a
3796       00000000      OFST:	set	0
3799                     ; 833     assert_param(IS_TIM1_UPDATE_SOURCE_OK(TIM1_UpdateSource));
3801  092a 4d            	tnz	a
3802  092b 2711          	jreq	L2001
3803  092d 4a            	dec	a
3804  092e 270e          	jreq	L2001
3805  0930 ae0341        	ldw	x,#833
...
3813  093e               L2001:
3814                     ; 836     if (TIM1_UpdateSource != TIM1_UPDATESOURCE_GLOBAL)
3816  093e 7b01          	ld	a,(OFST+1,sp)
3817  0940 2706          	jreq	L5631
3818                     ; 838         TIM1->CR1 |= TIM1_CR1_URS;
3820  0942 72145250      	bset	21072,#2
3822  0946 2004          	jra	L7631
3823  0948               L5631:
3824                     ; 842         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_URS);
3826  0948 72155250      	bres	21072,#2
3827  094c               L7631:
3828                     ; 844 }
3831  094c 84            	pop	a
3832  094d 81            	ret	
3869                     ; 853 void TIM1_SelectHallSensor(FunctionalState NewState)
3869                     ; 854 {
3870                     	switch	.text
3871  094e               _TIM1_SelectHallSensor:
3873  094e 88            	push	a
3874       00000000      OFST:	set	0
3877                     ; 856     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
3879  094f 4d            	tnz	a
3880  0950 2711          	jreq	L4101
3881  0952 4a            	dec	a
3882  0953 270e          	jreq	L4101
3883  0955 ae0358        	ldw	x,#856
...
3990  0989               L6201:
3991                     ; 884     if (TIM1_OPMode != TIM1_OPMODE_REPETITIVE)
3993  0989 7b01          	ld	a,(OFST+1,sp)
3994  098b 2706          	jreq	L1441
3995                     ; 886         TIM1->CR1 |= TIM1_CR1_OPM;
3997  098d 72165250      	bset	21072,#3
3999  0991 2004          	jra	L3441
4000  0993               L1441:
4001                     ; 890         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_OPM);
4003  0993 72175250      	bres	21072,#3
4004  0997               L3441:
4005                     ; 893 }
4008  0997 84            	pop	a
4009  0998 81            	ret	
4108                     ; 909 void TIM1_SelectOutputTrigger(TIM1_TRGOSource_TypeDef TIM1_TRGOSource)
4108                     ; 910 {
4109                     	switch	.text
4110  0999               _TIM1_SelectOutputTrigger:
4112  0999 88            	push	a
4113       00000000      OFST:	set	0
4116                     ; 912     assert_param(IS_TIM1_TRGO_SOURCE_OK(TIM1_TRGOSource));
4118  099a 4d            	tnz	a
...
4140  09c3               L0401:
4141                     ; 915     TIM1->CR2 = (uint8_t)((uint8_t)(TIM1->CR2 & (uint8_t)(~TIM1_CR2_MMS)) | 
4141                     ; 916                           (uint8_t) TIM1_TRGOSource);
...
4150  09cd 84            	pop	a
4151  09ce 81            	ret	
4226                     ; 929 void TIM1_SelectSlaveMode(TIM1_SlaveMode_TypeDef TIM1_SlaveMode)
4226                     ; 930 {
4227                     	switch	.text
4228  09cf               _TIM1_SelectSlaveMode:
4230  09cf 88            	push	a
4231       00000000      OFST:	set	0
4234                     ; 933     assert_param(IS_TIM1_SLAVE_MODE_OK(TIM1_SlaveMode));
...
4252  09ee               L2501:
4253                     ; 936     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~TIM1_SMCR_SMS)) |
4253                     ; 937                            (uint8_t)TIM1_SlaveMode);
...
4262  09f8 84            	pop	a
4263  09f9 81            	ret	
4300                     ; 947 void TIM1_SelectMasterSlaveMode(FunctionalState NewState)
4300                     ; 948 {
4301                     	switch	.text
4302  09fa               _TIM1_SelectMasterSlaveMode:
4304  09fa 88            	push	a
4305       00000000      OFST:	set	0
4308                     ; 950     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4310  09fb 4d            	tnz	a
4311  09fc 2711          	jreq	L4601
4312  09fe 4a            	dec	a
4313  09ff 270e          	jreq	L4601
4314  0a01 ae03b6        	ldw	x,#950
...
4322  0a0f               L4601:
4323                     ; 953     if (NewState != DISABLE)
4325  0a0f 7b01          	ld	a,(OFST+1,sp)
4326  0a11 2706          	jreq	L5551
4327                     ; 955         TIM1->SMCR |= TIM1_SMCR_MSM;
4329  0a13 721e5252      	bset	21074,#7
4331  0a17 2004          	jra	L7551
4332  0a19               L5551:
4333                     ; 959         TIM1->SMCR &= (uint8_t)(~TIM1_SMCR_MSM);
4335  0a19 721f5252      	bres	21074,#7
4336  0a1d               L7551:
4337                     ; 961 }
4340  0a1d 84            	pop	a
4341  0a1e 81            	ret	
4428                     ; 983 void TIM1_EncoderInterfaceConfig(TIM1_EncoderMode_TypeDef TIM1_EncoderMode,
4428                     ; 984                                  TIM1_ICPolarity_TypeDef TIM1_IC1Polarity,
4428                     ; 985                                  TIM1_ICPolarity_TypeDef TIM1_IC2Polarity)
4428                     ; 986 {
4429                     	switch	.text
4430  0a1f               _TIM1_EncoderInterfaceConfig:
4432  0a1f 89            	pushw	x
4433       00000000      OFST:	set	0
4436                     ; 990     assert_param(IS_TIM1_ENCODER_MODE_OK(TIM1_EncoderMode));
...
4455  0a3c               L6701:
4456                     ; 991     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_IC1Polarity));
4458  0a3c 7b02          	ld	a,(OFST+2,sp)
4459  0a3e 2711          	jreq	L6011
4460  0a40 4a            	dec	a
4461  0a41 270e          	jreq	L6011
4462  0a43 ae03df        	ldw	x,#991
...
4470  0a51               L6011:
4471                     ; 992     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_IC2Polarity));
4473  0a51 7b05          	ld	a,(OFST+5,sp)
4474  0a53 2711          	jreq	L6111
4475  0a55 4a            	dec	a
4476  0a56 270e          	jreq	L6111
4477  0a58 ae03e0        	ldw	x,#992
...
4485  0a66               L6111:
4486                     ; 995     if (TIM1_IC1Polarity != TIM1_ICPOLARITY_RISING)
4488  0a66 7b02          	ld	a,(OFST+2,sp)
4489  0a68 2706          	jreq	L1261
4490                     ; 997         TIM1->CCER1 |= TIM1_CCER1_CC1P;
4492  0a6a 7212525c      	bset	21084,#1
4494  0a6e 2004          	jra	L3261
4495  0a70               L1261:
4496                     ; 1001         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
4498  0a70 7213525c      	bres	21084,#1
4499  0a74               L3261:
4500                     ; 1004     if (TIM1_IC2Polarity != TIM1_ICPOLARITY_RISING)
4502  0a74 7b05          	ld	a,(OFST+5,sp)
4503  0a76 2706          	jreq	L5261
4504                     ; 1006         TIM1->CCER1 |= TIM1_CCER1_CC2P;
4506  0a78 721a525c      	bset	21084,#5
4508  0a7c 2004          	jra	L7261
4509  0a7e               L5261:
4510                     ; 1010         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
4512  0a7e 721b525c      	bres	21084,#5
4513  0a82               L7261:
4514                     ; 1013     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(TIM1_SMCR_MSM | TIM1_SMCR_TS))
4514                     ; 1014                            | (uint8_t) TIM1_EncoderMode);
4516  0a82 c65252        	ld	a,21074
4517  0a85 a4f0          	and	a,#240
4518  0a87 1a01          	or	a,(OFST+1,sp)
4519  0a89 c75252        	ld	21074,a
4520                     ; 1017     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_CCxS)) 
4520                     ; 1018                             | (uint8_t) CCMR_TIxDirect_Set);
4522  0a8c c65258        	ld	a,21080
4523  0a8f a4fc          	and	a,#252
4524  0a91 aa01          	or	a,#1
4525  0a93 c75258        	ld	21080,a
4526                     ; 1019     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_CCxS))
4526                     ; 1020                             | (uint8_t) CCMR_TIxDirect_Set);
...
4535  0aa0 85            	popw	x
4536  0aa1 81            	ret	
4602                     ; 1035 void TIM1_PrescalerConfig(uint16_t Prescaler,
4602                     ; 1036                           TIM1_PSCReloadMode_TypeDef TIM1_PSCReloadMode)
4602                     ; 1037 {
4603                     	switch	.text
4604  0aa2               _TIM1_PrescalerConfig:
4606  0aa2 89            	pushw	x
4607       00000000      OFST:	set	0
4610                     ; 1039     assert_param(IS_TIM1_PRESCALER_RELOAD_OK(TIM1_PSCReloadMode));
4612  0aa3 7b05          	ld	a,(OFST+5,sp)
4613  0aa5 2711          	jreq	L0311
4614  0aa7 4a            	dec	a
4615  0aa8 270e          	jreq	L0311
4616  0aaa ae040f        	ldw	x,#1039
...
4624  0ab8               L0311:
4625                     ; 1042     TIM1->PSCRH = (uint8_t)(Prescaler >> 8);
4627  0ab8 7b01          	ld	a,(OFST+1,sp)
4628  0aba c75260        	ld	21088,a
4629                     ; 1043     TIM1->PSCRL = (uint8_t)(Prescaler);
4631  0abd 7b02          	ld	a,(OFST+2,sp)
4632  0abf c75261        	ld	21089,a
4633                     ; 1046     TIM1->EGR = (uint8_t)TIM1_PSCReloadMode;
4635  0ac2 7b05          	ld	a,(OFST+5,sp)
4636  0ac4 c75257        	ld	21079,a
4637                     ; 1048 }
4640  0ac7 85            	popw	x
4641  0ac8 81            	ret	
4678                     ; 1061 void TIM1_CounterModeConfig(TIM1_CounterMode_TypeDef TIM1_CounterMode)
4678                     ; 1062 {
4679                     	switch	.text
4680  0ac9               _TIM1_CounterModeConfig:
4682  0ac9 88            	push	a
4683       00000000      OFST:	set	0
4686                     ; 1064     assert_param(IS_TIM1_COUNTER_MODE_OK(TIM1_CounterMode));
4688  0aca 4d            	tnz	a
...
4706  0aeb               L2411:
4707                     ; 1068     TIM1->CR1 = (uint8_t)((uint8_t)(TIM1->CR1 & (uint8_t)((uint8_t)(~TIM1_CR1_CMS) & (uint8_t)(~TIM1_CR1_DIR)))
4707                     ; 1069                           | (uint8_t)TIM1_CounterMode);
...
4716  0af5 84            	pop	a
4717  0af6 81            	ret	
4776                     ; 1081 void TIM1_ForcedOC1Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
4776                     ; 1082 {
4777                     	switch	.text
4778  0af7               _TIM1_ForcedOC1Config:
4780  0af7 88            	push	a
4781       00000000      OFST:	set	0
4784                     ; 1084     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
4786  0af8 a150          	cp	a,#80
4787  0afa 2712          	jreq	L4511
4788  0afc a140          	cp	a,#64
4789  0afe 270e          	jreq	L4511
4790  0b00 ae043c        	ldw	x,#1084
...
4798  0b0e               L4511:
4799                     ; 1087     TIM1->CCMR1 =  (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM))|
4799                     ; 1088                              (uint8_t)TIM1_ForcedAction);
...
4808  0b18 84            	pop	a
4809  0b19 81            	ret	
4846                     ; 1100 void TIM1_ForcedOC2Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
4846                     ; 1101 {
4847                     	switch	.text
4848  0b1a               _TIM1_ForcedOC2Config:
4850  0b1a 88            	push	a
4851       00000000      OFST:	set	0
4854                     ; 1103     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
4856  0b1b a150          	cp	a,#80
4857  0b1d 2712          	jreq	L6611
4858  0b1f a140          	cp	a,#64
4859  0b21 270e          	jreq	L6611
4860  0b23 ae044f        	ldw	x,#1103
...
4868  0b31               L6611:
4869                     ; 1106     TIM1->CCMR2  =  (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM))
4869                     ; 1107                               | (uint8_t)TIM1_ForcedAction);
...
4878  0b3b 84            	pop	a
4879  0b3c 81            	ret	
4916                     ; 1120 void TIM1_ForcedOC3Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
4916                     ; 1121 {
4917                     	switch	.text
4918  0b3d               _TIM1_ForcedOC3Config:
4920  0b3d 88            	push	a
4921       00000000      OFST:	set	0
4924                     ; 1123     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
4926  0b3e a150          	cp	a,#80
4927  0b40 2712          	jreq	L0021
4928  0b42 a140          	cp	a,#64
4929  0b44 270e          	jreq	L0021
4930  0b46 ae0463        	ldw	x,#1123
...
4938  0b54               L0021:
4939                     ; 1126     TIM1->CCMR3  =  (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM))  
4939                     ; 1127                               | (uint8_t)TIM1_ForcedAction);
...
4948  0b5e 84            	pop	a
4949  0b5f 81            	ret	
4986                     ; 1140 void TIM1_ForcedOC4Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
4986                     ; 1141 {
4987                     	switch	.text
4988  0b60               _TIM1_ForcedOC4Config:
4990  0b60 88            	push	a
4991       00000000      OFST:	set	0
4994                     ; 1143     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
4996  0b61 a150          	cp	a,#80
4997  0b63 2712          	jreq	L2121
4998  0b65 a140          	cp	a,#64
4999  0b67 270e          	jreq	L2121
5000  0b69 ae0477        	ldw	x,#1143
...
5008  0b77               L2121:
5009                     ; 1146     TIM1->CCMR4  =  (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) 
5009                     ; 1147                               | (uint8_t)TIM1_ForcedAction);
...
5018  0b81 84            	pop	a
5019  0b82 81            	ret	
5056                     ; 1157 void TIM1_ARRPreloadConfig(FunctionalState NewState)
5056                     ; 1158 {
5057                     	switch	.text
5058  0b83               _TIM1_ARRPreloadConfig:
5060  0b83 88            	push	a
5061       00000000      OFST:	set	0
5064                     ; 1160     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5066  0b84 4d            	tnz	a
5067  0b85 2711          	jreq	L4221
5068  0b87 4a            	dec	a
5069  0b88 270e          	jreq	L4221
5070  0b8a ae0488        	ldw	x,#1160
...
5311  0c07               L2621:
5312                     ; 1231     if (NewState != DISABLE)
5314  0c07 7b01          	ld	a,(OFST+1,sp)
5315  0c09 2706          	jreq	L3012
5316                     ; 1233         TIM1->CCMR1 |= TIM1_CCMR_OCxPE;
5318  0c0b 72165258      	bset	21080,#3
5320  0c0f 2004          	jra	L5012
5321  0c11               L3012:
5322                     ; 1237         TIM1->CCMR1 &= (uint8_t)(~TIM1_CCMR_OCxPE);
5324  0c11 72175258      	bres	21080,#3
5325  0c15               L5012:
5326                     ; 1239 }
5329  0c15 84            	pop	a
5330  0c16 81            	ret	
5367                     ; 1248 void TIM1_OC2PreloadConfig(FunctionalState NewState)
5367                     ; 1249 {
5368                     	switch	.text
5369  0c17               _TIM1_OC2PreloadConfig:
5371  0c17 88            	push	a
5372       00000000      OFST:	set	0
5375                     ; 1251     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5377  0c18 4d            	tnz	a
5378  0c19 2711          	jreq	L4721
5379  0c1b 4a            	dec	a
5380  0c1c 270e          	jreq	L4721
5381  0c1e ae04e3        	ldw	x,#1251
...
5389  0c2c               L4721:
5390                     ; 1254     if (NewState != DISABLE)
5392  0c2c 7b01          	ld	a,(OFST+1,sp)
5393  0c2e 2706          	jreq	L5212
5394                     ; 1256         TIM1->CCMR2 |= TIM1_CCMR_OCxPE;
5396  0c30 72165259      	bset	21081,#3
5398  0c34 2004          	jra	L7212
5399  0c36               L5212:
5400                     ; 1260         TIM1->CCMR2 &= (uint8_t)(~TIM1_CCMR_OCxPE);
5402  0c36 72175259      	bres	21081,#3
5403  0c3a               L7212:
5404                     ; 1262 }
5407  0c3a 84            	pop	a
5408  0c3b 81            	ret	
5445                     ; 1271 void TIM1_OC3PreloadConfig(FunctionalState NewState)
5445                     ; 1272 {
5446                     	switch	.text
5447  0c3c               _TIM1_OC3PreloadConfig:
5449  0c3c 88            	push	a
5450       00000000      OFST:	set	0
5453                     ; 1274     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5455  0c3d 4d            	tnz	a
5456  0c3e 2711          	jreq	L6031
5457  0c40 4a            	dec	a
5458  0c41 270e          	jreq	L6031
5459  0c43 ae04fa        	ldw	x,#1274
...
5467  0c51               L6031:
5468                     ; 1277     if (NewState != DISABLE)
5470  0c51 7b01          	ld	a,(OFST+1,sp)
5471  0c53 2706          	jreq	L7412
5472                     ; 1279         TIM1->CCMR3 |= TIM1_CCMR_OCxPE;
5474  0c55 7216525a      	bset	21082,#3
5476  0c59 2004          	jra	L1512
5477  0c5b               L7412:
5478                     ; 1283         TIM1->CCMR3 &= (uint8_t)(~TIM1_CCMR_OCxPE);
5480  0c5b 7217525a      	bres	21082,#3
5481  0c5f               L1512:
5482                     ; 1285 }
5485  0c5f 84            	pop	a
5486  0c60 81            	ret	
5523                     ; 1295 void TIM1_OC4PreloadConfig(FunctionalState NewState)
5523                     ; 1296 {
5524                     	switch	.text
5525  0c61               _TIM1_OC4PreloadConfig:
5527  0c61 88            	push	a
5528       00000000      OFST:	set	0
5531                     ; 1298     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5533  0c62 4d            	tnz	a
5534  0c63 2711          	jreq	L0231
5535  0c65 4a            	dec	a
5536  0c66 270e          	jreq	L0231
5537  0c68 ae0512        	ldw	x,#1298
...
5545  0c76               L0231:
5546                     ; 1301     if (NewState != DISABLE)
5548  0c76 7b01          	ld	a,(OFST+1,sp)
5549  0c78 2706          	jreq	L1712
5550                     ; 1303         TIM1->CCMR4 |= TIM1_CCMR_OCxPE;
5552  0c7a 7216525b      	bset	21083,#3
5554  0c7e 2004          	jra	L3712
5555  0c80               L1712:
5556                     ; 1307         TIM1->CCMR4 &= (uint8_t)(~TIM1_CCMR_OCxPE);
5558  0c80 7217525b      	bres	21083,#3
5559  0c84               L3712:
5560                     ; 1309 }
5563  0c84 84            	pop	a
5564  0c85 81            	ret	
5600                     ; 1317 void TIM1_OC1FastConfig(FunctionalState NewState)
5600                     ; 1318 {
5601                     	switch	.text
5602  0c86               _TIM1_OC1FastConfig:
5604  0c86 88            	push	a
5605       00000000      OFST:	set	0
5608                     ; 1320     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5610  0c87 4d            	tnz	a
5611  0c88 2711          	jreq	L2331
5612  0c8a 4a            	dec	a
5613  0c8b 270e          	jreq	L2331
5614  0c8d ae0528        	ldw	x,#1320
...
5622  0c9b               L2331:
5623                     ; 1323     if (NewState != DISABLE)
5625  0c9b 7b01          	ld	a,(OFST+1,sp)
5626  0c9d 2706          	jreq	L3122
5627                     ; 1325         TIM1->CCMR1 |= TIM1_CCMR_OCxFE;
5629  0c9f 72145258      	bset	21080,#2
5631  0ca3 2004          	jra	L5122
5632  0ca5               L3122:
5633                     ; 1329         TIM1->CCMR1 &= (uint8_t)(~TIM1_CCMR_OCxFE);
5635  0ca5 72155258      	bres	21080,#2
5636  0ca9               L5122:
5637                     ; 1331 }
5640  0ca9 84            	pop	a
5641  0caa 81            	ret	
5677                     ; 1341 void TIM1_OC2FastConfig(FunctionalState NewState)
5677                     ; 1342 {
5678                     	switch	.text
5679  0cab               _TIM1_OC2FastConfig:
5681  0cab 88            	push	a
5682       00000000      OFST:	set	0
5685                     ; 1344     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5687  0cac 4d            	tnz	a
5688  0cad 2711          	jreq	L4431
5689  0caf 4a            	dec	a
5690  0cb0 270e          	jreq	L4431
5691  0cb2 ae0540        	ldw	x,#1344
...
5699  0cc0               L4431:
5700                     ; 1347     if (NewState != DISABLE)
5702  0cc0 7b01          	ld	a,(OFST+1,sp)
5703  0cc2 2706          	jreq	L5322
5704                     ; 1349         TIM1->CCMR2 |= TIM1_CCMR_OCxFE;
5706  0cc4 72145259      	bset	21081,#2
5708  0cc8 2004          	jra	L7322
5709  0cca               L5322:
5710                     ; 1353         TIM1->CCMR2 &= (uint8_t)(~TIM1_CCMR_OCxFE);
5712  0cca 72155259      	bres	21081,#2
5713  0cce               L7322:
5714                     ; 1355 }
5717  0cce 84            	pop	a
5718  0ccf 81            	ret	
5754                     ; 1364 void TIM1_OC3FastConfig(FunctionalState NewState)
5754                     ; 1365 {
5755                     	switch	.text
5756  0cd0               _TIM1_OC3FastConfig:
5758  0cd0 88            	push	a
5759       00000000      OFST:	set	0
5762                     ; 1367     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5764  0cd1 4d            	tnz	a
5765  0cd2 2711          	jreq	L6531
5766  0cd4 4a            	dec	a
5767  0cd5 270e          	jreq	L6531
5768  0cd7 ae0557        	ldw	x,#1367
...
5776  0ce5               L6531:
5777                     ; 1370     if (NewState != DISABLE)
5779  0ce5 7b01          	ld	a,(OFST+1,sp)
5780  0ce7 2706          	jreq	L7522
5781                     ; 1372         TIM1->CCMR3 |= TIM1_CCMR_OCxFE;
5783  0ce9 7214525a      	bset	21082,#2
5785  0ced 2004          	jra	L1622
5786  0cef               L7522:
5787                     ; 1376         TIM1->CCMR3 &= (uint8_t)(~TIM1_CCMR_OCxFE);
5789  0cef 7215525a      	bres	21082,#2
5790  0cf3               L1622:
5791                     ; 1378 }
5794  0cf3 84            	pop	a
5795  0cf4 81            	ret	
5831                     ; 1387 void TIM1_OC4FastConfig(FunctionalState NewState)
5831                     ; 1388 {
5832                     	switch	.text
5833  0cf5               _TIM1_OC4FastConfig:
5835  0cf5 88            	push	a
5836       00000000      OFST:	set	0
5839                     ; 1390     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5841  0cf6 4d            	tnz	a
5842  0cf7 2711          	jreq	L0731
5843  0cf9 4a            	dec	a
5844  0cfa 270e          	jreq	L0731
5845  0cfc ae056e        	ldw	x,#1390
...
5853  0d0a               L0731:
5854                     ; 1393     if (NewState != DISABLE)
5856  0d0a 7b01          	ld	a,(OFST+1,sp)
5857  0d0c 2706          	jreq	L1032
5858                     ; 1395         TIM1->CCMR4 |= TIM1_CCMR_OCxFE;
5860  0d0e 7214525b      	bset	21083,#2
5862  0d12 2004          	jra	L3032
5863  0d14               L1032:
5864                     ; 1399         TIM1->CCMR4 &= (uint8_t)(~TIM1_CCMR_OCxFE);
5866  0d14 7215525b      	bres	21083,#2
5867  0d18               L3032:
5868                     ; 1401 }
5871  0d18 84            	pop	a
5872  0d19 81            	ret	
5978                     ; 1418 void TIM1_GenerateEvent(TIM1_EventSource_TypeDef TIM1_EventSource)
5978                     ; 1419 {
5979                     	switch	.text
5980  0d1a               _TIM1_GenerateEvent:
5982  0d1a 88            	push	a
5983       00000000      OFST:	set	0
5986                     ; 1421     assert_param(IS_TIM1_EVENT_SOURCE_OK(TIM1_EventSource));
5988  0d1b 4d            	tnz	a
5989  0d1c 260e          	jrne	L0041
5990  0d1e ae058d        	ldw	x,#1421
...
5998  0d2c               L0041:
5999                     ; 1424     TIM1->EGR = (uint8_t)TIM1_EventSource;
6001  0d2c 7b01          	ld	a,(OFST+1,sp)
6002  0d2e c75257        	ld	21079,a
6003                     ; 1425 }
6006  0d31 84            	pop	a
6007  0d32 81            	ret	
6044                     ; 1436 void TIM1_OC1PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6044                     ; 1437 {
6045                     	switch	.text
6046  0d33               _TIM1_OC1PolarityConfig:
6048  0d33 88            	push	a
6049       00000000      OFST:	set	0
6052                     ; 1439     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6054  0d34 4d            	tnz	a
6055  0d35 2712          	jreq	L2141
6056  0d37 a122          	cp	a,#34
6057  0d39 270e          	jreq	L2141
6058  0d3b ae059f        	ldw	x,#1439
...
6066  0d49               L2141:
6067                     ; 1442     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6069  0d49 7b01          	ld	a,(OFST+1,sp)
6070  0d4b 2706          	jreq	L5632
6071                     ; 1444         TIM1->CCER1 |= TIM1_CCER1_CC1P;
6073  0d4d 7212525c      	bset	21084,#1
6075  0d51 2004          	jra	L7632
6076  0d53               L5632:
6077                     ; 1448         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
6079  0d53 7213525c      	bres	21084,#1
6080  0d57               L7632:
6081                     ; 1450 }
6084  0d57 84            	pop	a
6085  0d58 81            	ret	
6122                     ; 1461 void TIM1_OC1NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
6122                     ; 1462 {
6123                     	switch	.text
6124  0d59               _TIM1_OC1NPolarityConfig:
6126  0d59 88            	push	a
6127       00000000      OFST:	set	0
6130                     ; 1464     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
6132  0d5a 4d            	tnz	a
6133  0d5b 2712          	jreq	L4241
6134  0d5d a188          	cp	a,#136
6135  0d5f 270e          	jreq	L4241
6136  0d61 ae05b8        	ldw	x,#1464
...
6144  0d6f               L4241:
6145                     ; 1467     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
6147  0d6f 7b01          	ld	a,(OFST+1,sp)
6148  0d71 2706          	jreq	L7042
6149                     ; 1469         TIM1->CCER1 |= TIM1_CCER1_CC1NP;
6151  0d73 7216525c      	bset	21084,#3
6153  0d77 2004          	jra	L1142
6154  0d79               L7042:
6155                     ; 1473         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1NP);
6157  0d79 7217525c      	bres	21084,#3
6158  0d7d               L1142:
6159                     ; 1475 }
6162  0d7d 84            	pop	a
6163  0d7e 81            	ret	
6200                     ; 1486 void TIM1_OC2PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6200                     ; 1487 {
6201                     	switch	.text
6202  0d7f               _TIM1_OC2PolarityConfig:
6204  0d7f 88            	push	a
6205       00000000      OFST:	set	0
6208                     ; 1489     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6210  0d80 4d            	tnz	a
6211  0d81 2712          	jreq	L6341
6212  0d83 a122          	cp	a,#34
6213  0d85 270e          	jreq	L6341
6214  0d87 ae05d1        	ldw	x,#1489
...
6222  0d95               L6341:
6223                     ; 1492     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6225  0d95 7b01          	ld	a,(OFST+1,sp)
6226  0d97 2706          	jreq	L1342
6227                     ; 1494         TIM1->CCER1 |= TIM1_CCER1_CC2P;
6229  0d99 721a525c      	bset	21084,#5
6231  0d9d 2004          	jra	L3342
6232  0d9f               L1342:
6233                     ; 1498         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
6235  0d9f 721b525c      	bres	21084,#5
6236  0da3               L3342:
6237                     ; 1500 }
6240  0da3 84            	pop	a
6241  0da4 81            	ret	
6278                     ; 1510 void TIM1_OC2NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
6278                     ; 1511 {
6279                     	switch	.text
6280  0da5               _TIM1_OC2NPolarityConfig:
6282  0da5 88            	push	a
6283       00000000      OFST:	set	0
6286                     ; 1513     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
6288  0da6 4d            	tnz	a
6289  0da7 2712          	jreq	L0541
6290  0da9 a188          	cp	a,#136
6291  0dab 270e          	jreq	L0541
6292  0dad ae05e9        	ldw	x,#1513
...
6300  0dbb               L0541:
6301                     ; 1516     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
6303  0dbb 7b01          	ld	a,(OFST+1,sp)
6304  0dbd 2706          	jreq	L3542
6305                     ; 1518         TIM1->CCER1 |= TIM1_CCER1_CC2NP;
6307  0dbf 721e525c      	bset	21084,#7
6309  0dc3 2004          	jra	L5542
6310  0dc5               L3542:
6311                     ; 1522         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2NP);
6313  0dc5 721f525c      	bres	21084,#7
6314  0dc9               L5542:
6315                     ; 1524 }
6318  0dc9 84            	pop	a
6319  0dca 81            	ret	
6356                     ; 1535 void TIM1_OC3PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6356                     ; 1536 {
6357                     	switch	.text
6358  0dcb               _TIM1_OC3PolarityConfig:
6360  0dcb 88            	push	a
6361       00000000      OFST:	set	0
6364                     ; 1538     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6366  0dcc 4d            	tnz	a
6367  0dcd 2712          	jreq	L2641
6368  0dcf a122          	cp	a,#34
6369  0dd1 270e          	jreq	L2641
6370  0dd3 ae0602        	ldw	x,#1538
...
6378  0de1               L2641:
6379                     ; 1541     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6381  0de1 7b01          	ld	a,(OFST+1,sp)
6382  0de3 2706          	jreq	L5742
6383                     ; 1543         TIM1->CCER2 |= TIM1_CCER2_CC3P;
6385  0de5 7212525d      	bset	21085,#1
6387  0de9 2004          	jra	L7742
6388  0deb               L5742:
6389                     ; 1547         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3P);
6391  0deb 7213525d      	bres	21085,#1
6392  0def               L7742:
6393                     ; 1549 }
6396  0def 84            	pop	a
6397  0df0 81            	ret	
6434                     ; 1560 void TIM1_OC3NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
6434                     ; 1561 {
6435                     	switch	.text
6436  0df1               _TIM1_OC3NPolarityConfig:
6438  0df1 88            	push	a
6439       00000000      OFST:	set	0
6442                     ; 1563     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
6444  0df2 4d            	tnz	a
6445  0df3 2712          	jreq	L4741
6446  0df5 a188          	cp	a,#136
6447  0df7 270e          	jreq	L4741
6448  0df9 ae061b        	ldw	x,#1563
...
6456  0e07               L4741:
6457                     ; 1566     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
6459  0e07 7b01          	ld	a,(OFST+1,sp)
6460  0e09 2706          	jreq	L7152
6461                     ; 1568         TIM1->CCER2 |= TIM1_CCER2_CC3NP;
6463  0e0b 7216525d      	bset	21085,#3
6465  0e0f 2004          	jra	L1252
6466  0e11               L7152:
6467                     ; 1572         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3NP);
6469  0e11 7217525d      	bres	21085,#3
6470  0e15               L1252:
6471                     ; 1574 }
6474  0e15 84            	pop	a
6475  0e16 81            	ret	
6512                     ; 1584 void TIM1_OC4PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6512                     ; 1585 {
6513                     	switch	.text
6514  0e17               _TIM1_OC4PolarityConfig:
6516  0e17 88            	push	a
6517       00000000      OFST:	set	0
6520                     ; 1587     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6522  0e18 4d            	tnz	a
6523  0e19 2712          	jreq	L6051
6524  0e1b a122          	cp	a,#34
6525  0e1d 270e          	jreq	L6051
6526  0e1f ae0633        	ldw	x,#1587
...
6534  0e2d               L6051:
6535                     ; 1590     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6537  0e2d 7b01          	ld	a,(OFST+1,sp)
6538  0e2f 2706          	jreq	L1452
6539                     ; 1592         TIM1->CCER2 |= TIM1_CCER2_CC4P;
6541  0e31 721a525d      	bset	21085,#5
6543  0e35 2004          	jra	L3452
6544  0e37               L1452:
6545                     ; 1596         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4P);
6547  0e37 721b525d      	bres	21085,#5
6548  0e3b               L3452:
6549                     ; 1598 }
6552  0e3b 84            	pop	a
6553  0e3c 81            	ret	
6599                     ; 1613 void TIM1_CCxCmd(TIM1_Channel_TypeDef TIM1_Channel, FunctionalState NewState)
6599                     ; 1614 {
6600                     	switch	.text
6601  0e3d               _TIM1_CCxCmd:
6603  0e3d 89            	pushw	x
6604       00000000      OFST:	set	0
6607                     ; 1616     assert_param(IS_TIM1_CHANNEL_OK(TIM1_Channel));
...
6629  0e5e               L0251:
6630                     ; 1617     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
6632  0e5e 7b02          	ld	a,(OFST+2,sp)
6633  0e60 2711          	jreq	L0351
6634  0e62 4a            	dec	a
6635  0e63 270e          	jreq	L0351
6636  0e65 ae0651        	ldw	x,#1617
...
6793  0edb               L2451:
6794                     ; 1685     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
6796  0edb 7b02          	ld	a,(OFST+2,sp)
6797  0edd 2711          	jreq	L2551
6798  0edf 4a            	dec	a
6799  0ee0 270e          	jreq	L2551
6800  0ee2 ae0695        	ldw	x,#1685
...
6941  0f48               L4651:
6942                     ; 1751     assert_param(IS_TIM1_OCM_OK(TIM1_OCMode));
...
6968  0f76               L4751:
6969                     ; 1753     if (TIM1_Channel == TIM1_CHANNEL_1)
6971  0f76 7b01          	ld	a,(OFST+1,sp)
6972  0f78 2610          	jrne	L3172
6973                     ; 1756         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1E);
6975  0f7a 7211525c      	bres	21084,#0
6976                     ; 1759         TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM)) 
6976                     ; 1760                                 | (uint8_t)TIM1_OCMode);
...
6984  0f8a               L3172:
6985                     ; 1762     else if (TIM1_Channel == TIM1_CHANNEL_2)
6987  0f8a a101          	cp	a,#1
6988  0f8c 2610          	jrne	L7172
6989                     ; 1765         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2E);
6991  0f8e 7219525c      	bres	21084,#4
6992                     ; 1768         TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM))
6992                     ; 1769                                 | (uint8_t)TIM1_OCMode);
...
7000  0f9e               L7172:
7001                     ; 1771     else if (TIM1_Channel == TIM1_CHANNEL_3)
7003  0f9e a102          	cp	a,#2
7004  0fa0 2610          	jrne	L3272
7005                     ; 1774         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3E);
7007  0fa2 7211525d      	bres	21085,#0
7008                     ; 1777         TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM)) 
7008                     ; 1778                                 | (uint8_t)TIM1_OCMode);
...
7016  0fb2               L3272:
7017                     ; 1783         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4E);
7019  0fb2 7219525d      	bres	21085,#4
7020                     ; 1786         TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) 
7020                     ; 1787                                 | (uint8_t)TIM1_OCMode);
...
7030  0fc0 85            	popw	x
7031  0fc1 81            	ret	
7063                     ; 1798 void TIM1_SetCounter(uint16_t Counter)
7063                     ; 1799 {
7064                     	switch	.text
7065  0fc2               _TIM1_SetCounter:
7069                     ; 1801     TIM1->CNTRH = (uint8_t)(Counter >> 8);
7071  0fc2 9e            	ld	a,xh
7072  0fc3 c7525e        	ld	21086,a
7073                     ; 1802     TIM1->CNTRL = (uint8_t)(Counter);
7075  0fc6 9f            	ld	a,xl
7076  0fc7 c7525f        	ld	21087,a
7077                     ; 1804 }
7080  0fca 81            	ret	
7112                     ; 1813 void TIM1_SetAutoreload(uint16_t Autoreload)
7112                     ; 1814 {
7113                     	switch	.text
7114  0fcb               _TIM1_SetAutoreload:
7118                     ; 1817     TIM1->ARRH = (uint8_t)(Autoreload >> 8);
7120  0fcb 9e            	ld	a,xh
7121  0fcc c75262        	ld	21090,a
7122                     ; 1818     TIM1->ARRL = (uint8_t)(Autoreload);
7124  0fcf 9f            	ld	a,xl
7125  0fd0 c75263        	ld	21091,a
7126                     ; 1820 }
7129  0fd3 81            	ret	
7161                     ; 1829 void TIM1_SetCompare1(uint16_t Compare1)
7161                     ; 1830 {
7162                     	switch	.text
7163  0fd4               _TIM1_SetCompare1:
7167                     ; 1832     TIM1->CCR1H = (uint8_t)(Compare1 >> 8);
7169  0fd4 9e            	ld	a,xh
7170  0fd5 c75265        	ld	21093,a
7171                     ; 1833     TIM1->CCR1L = (uint8_t)(Compare1);
7173  0fd8 9f            	ld	a,xl
7174  0fd9 c75266        	ld	21094,a
7175                     ; 1835 }
7178  0fdc 81            	ret	
7210                     ; 1844 void TIM1_SetCompare2(uint16_t Compare2)
7210                     ; 1845 {
7211                     	switch	.text
7212  0fdd               _TIM1_SetCompare2:
7216                     ; 1847     TIM1->CCR2H = (uint8_t)(Compare2 >> 8);
7218  0fdd 9e            	ld	a,xh
7219  0fde c75267        	ld	21095,a
7220                     ; 1848     TIM1->CCR2L = (uint8_t)(Compare2);
7222  0fe1 9f            	ld	a,xl
7223  0fe2 c75268        	ld	21096,a
7224                     ; 1850 }
7227  0fe5 81            	ret	
7259                     ; 1859 void TIM1_SetCompare3(uint16_t Compare3)
7259                     ; 1860 {
7260                     	switch	.text
7261  0fe6               _TIM1_SetCompare3:
7265                     ; 1862     TIM1->CCR3H = (uint8_t)(Compare3 >> 8);
7267  0fe6 9e            	ld	a,xh
7268  0fe7 c75269        	ld	21097,a
7269                     ; 1863     TIM1->CCR3L = (uint8_t)(Compare3);
7271  0fea 9f            	ld	a,xl
7272  0feb c7526a        	ld	21098,a
7273                     ; 1865 }
7276  0fee 81            	ret	
7308                     ; 1874 void TIM1_SetCompare4(uint16_t Compare4)
7308                     ; 1875 {
7309                     	switch	.text
7310  0fef               _TIM1_SetCompare4:
7314                     ; 1877     TIM1->CCR4H = (uint8_t)(Compare4 >> 8);
7316  0fef 9e            	ld	a,xh
7317  0ff0 c7526b        	ld	21099,a
7318                     ; 1878     TIM1->CCR4L = (uint8_t)(Compare4);
7320  0ff3 9f            	ld	a,xl
7321  0ff4 c7526c        	ld	21100,a
7322                     ; 1879 }
7325  0ff7 81            	ret	
7362                     ; 1892 void TIM1_SetIC1Prescaler(TIM1_ICPSC_TypeDef TIM1_IC1Prescaler)
7362                     ; 1893 {
7363                     	switch	.text
7364  0ff8               _TIM1_SetIC1Prescaler:
7366  0ff8 88            	push	a
7367       00000000      OFST:	set	0
7370                     ; 1895     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC1Prescaler));
7372  0ff9 4d            	tnz	a
...
7388  1016               L2261:
7389                     ; 1898     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_ICxPSC)) 
7389                     ; 1899                             | (uint8_t)TIM1_IC1Prescaler);
...
7398  1020 84            	pop	a
7399  1021 81            	ret	
7436                     ; 1913 void TIM1_SetIC2Prescaler(TIM1_ICPSC_TypeDef TIM1_IC2Prescaler)
7436                     ; 1914 {
7437                     	switch	.text
7438  1022               _TIM1_SetIC2Prescaler:
7440  1022 88            	push	a
7441       00000000      OFST:	set	0
7444                     ; 1917     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC2Prescaler));
7446  1023 4d            	tnz	a
...
7462  1040               L4361:
7463                     ; 1920     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_ICxPSC))
7463                     ; 1921                             | (uint8_t)TIM1_IC2Prescaler);
...
7472  104a 84            	pop	a
7473  104b 81            	ret	
7510                     ; 1935 void TIM1_SetIC3Prescaler(TIM1_ICPSC_TypeDef TIM1_IC3Prescaler)
7510                     ; 1936 {
7511                     	switch	.text
7512  104c               _TIM1_SetIC3Prescaler:
7514  104c 88            	push	a
7515       00000000      OFST:	set	0
7518                     ; 1939     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC3Prescaler));
7520  104d 4d            	tnz	a
...
7536  106a               L6461:
7537                     ; 1942     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_ICxPSC)) | 
7537                     ; 1943                             (uint8_t)TIM1_IC3Prescaler);
...
7546  1074 84            	pop	a
7547  1075 81            	ret	
7584                     ; 1956 void TIM1_SetIC4Prescaler(TIM1_ICPSC_TypeDef TIM1_IC4Prescaler)
7584                     ; 1957 {
7585                     	switch	.text
7586  1076               _TIM1_SetIC4Prescaler:
7588  1076 88            	push	a
7589       00000000      OFST:	set	0
7592                     ; 1960     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC4Prescaler));
7594  1077 4d            	tnz	a
...
7610  1094               L0661:
7611                     ; 1963     TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_ICxPSC)) |
7611                     ; 1964                             (uint8_t)TIM1_IC4Prescaler);
...
7620  109e 84            	pop	a
7621  109f 81            	ret	
7667                     ; 1972 uint16_t TIM1_GetCapture1(void)
7667                     ; 1973 {
7668                     	switch	.text
7669  10a0               _TIM1_GetCapture1:
7671  10a0 5204          	subw	sp,#4
7672       00000004      OFST:	set	4
7675                     ; 1976     uint16_t tmpccr1 = 0;
7677                     ; 1977     uint8_t tmpccr1l=0, tmpccr1h=0;
7681                     ; 1979     tmpccr1h = TIM1->CCR1H;
7683  10a2 c65265        	ld	a,21093
7684  10a5 6b02          	ld	(OFST-2,sp),a
7685                     ; 1980     tmpccr1l = TIM1->CCR1L;
7687  10a7 c65266        	ld	a,21094
7688  10aa 6b01          	ld	(OFST-3,sp),a
7689                     ; 1982     tmpccr1 = (uint16_t)(tmpccr1l);
7691  10ac 5f            	clrw	x
7692  10ad 97            	ld	xl,a
7693  10ae 1f03          	ldw	(OFST-1,sp),x
7694                     ; 1983     tmpccr1 |= (uint16_t)((uint16_t)tmpccr1h << 8);
7696  10b0 5f            	clrw	x
...
7703                     ; 1985     return (uint16_t)tmpccr1;
7707  10ba 5b04          	addw	sp,#4
7708  10bc 81            	ret	
7754                     ; 1993 uint16_t TIM1_GetCapture2(void)
7754                     ; 1994 {
7755                     	switch	.text
7756  10bd               _TIM1_GetCapture2:
7758  10bd 5204          	subw	sp,#4
7759       00000004      OFST:	set	4
7762                     ; 1997     uint16_t tmpccr2 = 0;
7764                     ; 1998     uint8_t tmpccr2l=0, tmpccr2h=0;
7768                     ; 2000     tmpccr2h = TIM1->CCR2H;
7770  10bf c65267        	ld	a,21095
7771  10c2 6b02          	ld	(OFST-2,sp),a
7772                     ; 2001     tmpccr2l = TIM1->CCR2L;
7774  10c4 c65268        	ld	a,21096
7775  10c7 6b01          	ld	(OFST-3,sp),a
7776                     ; 2003     tmpccr2 = (uint16_t)(tmpccr2l);
7778  10c9 5f            	clrw	x
7779  10ca 97            	ld	xl,a
7780  10cb 1f03          	ldw	(OFST-1,sp),x
7781                     ; 2004     tmpccr2 |= (uint16_t)((uint16_t)tmpccr2h << 8);
7783  10cd 5f            	clrw	x
...
7790                     ; 2006     return (uint16_t)tmpccr2;
7794  10d7 5b04          	addw	sp,#4
7795  10d9 81            	ret	
7841                     ; 2014 uint16_t TIM1_GetCapture3(void)
7841                     ; 2015 {
7842                     	switch	.text
7843  10da               _TIM1_GetCapture3:
7845  10da 5204          	subw	sp,#4
7846       00000004      OFST:	set	4
7849                     ; 2017     uint16_t tmpccr3 = 0;
7851                     ; 2018     uint8_t tmpccr3l=0, tmpccr3h=0;
7855                     ; 2020     tmpccr3h = TIM1->CCR3H;
7857  10dc c65269        	ld	a,21097
7858  10df 6b02          	ld	(OFST-2,sp),a
7859                     ; 2021     tmpccr3l = TIM1->CCR3L;
7861  10e1 c6526a        	ld	a,21098
7862  10e4 6b01          	ld	(OFST-3,sp),a
7863                     ; 2023     tmpccr3 = (uint16_t)(tmpccr3l);
7865  10e6 5f            	clrw	x
7866  10e7 97            	ld	xl,a
7867  10e8 1f03          	ldw	(OFST-1,sp),x
7868                     ; 2024     tmpccr3 |= (uint16_t)((uint16_t)tmpccr3h << 8);
7870  10ea 5f            	clrw	x
...
7877                     ; 2026     return (uint16_t)tmpccr3;
7881  10f4 5b04          	addw	sp,#4
7882  10f6 81            	ret	
7928                     ; 2034 uint16_t TIM1_GetCapture4(void)
7928                     ; 2035 {
7929                     	switch	.text
7930  10f7               _TIM1_GetCapture4:
7932  10f7 5204          	subw	sp,#4
7933       00000004      OFST:	set	4
7936                     ; 2037     uint16_t tmpccr4 = 0;
7938                     ; 2038     uint8_t tmpccr4l=0, tmpccr4h=0;
7942                     ; 2040     tmpccr4h = TIM1->CCR4H;
7944  10f9 c6526b        	ld	a,21099
7945  10fc 6b02          	ld	(OFST-2,sp),a
7946                     ; 2041     tmpccr4l = TIM1->CCR4L;
7948  10fe c6526c        	ld	a,21100
7949  1101 6b01          	ld	(OFST-3,sp),a
7950                     ; 2043     tmpccr4 = (uint16_t)(tmpccr4l);
7952  1103 5f            	clrw	x
7953  1104 97            	ld	xl,a
7954  1105 1f03          	ldw	(OFST-1,sp),x
7955                     ; 2044     tmpccr4 |= (uint16_t)((uint16_t)tmpccr4h << 8);
7957  1107 5f            	clrw	x
...
7964                     ; 2046     return (uint16_t)tmpccr4;
7968  1111 5b04          	addw	sp,#4
7969  1113 81            	ret	
8001                     ; 2054 uint16_t TIM1_GetCounter(void)
8001                     ; 2055 {
8002                     	switch	.text
8003  1114               _TIM1_GetCounter:
8005  1114 89            	pushw	x
8006       00000002      OFST:	set	2
8009                     ; 2056   uint16_t tmpcntr = 0;
8011                     ; 2058   tmpcntr = ((uint16_t)TIM1->CNTRH << 8);
8013  1115 c6525e        	ld	a,21086
8014  1118 97            	ld	xl,a
8015  1119 4f            	clr	a
8016  111a 02            	rlwa	x,a
8017  111b 1f01          	ldw	(OFST-1,sp),x
8018                     ; 2061     return (uint16_t)(tmpcntr | (uint16_t)(TIM1->CNTRL));
8020  111d c6525f        	ld	a,21087
8021  1120 5f            	clrw	x
...
8031  112b 81            	ret	
8063                     ; 2069 uint16_t TIM1_GetPrescaler(void)
8063                     ; 2070 {
8064                     	switch	.text
8065  112c               _TIM1_GetPrescaler:
8067  112c 89            	pushw	x
8068       00000002      OFST:	set	2
8071                     ; 2071    uint16_t temp = 0;
8073                     ; 2073    temp = ((uint16_t)TIM1->PSCRH << 8);
8075  112d c65260        	ld	a,21088
8076  1130 97            	ld	xl,a
8077  1131 4f            	clr	a
8078  1132 02            	rlwa	x,a
8079  1133 1f01          	ldw	(OFST-1,sp),x
8080                     ; 2076     return (uint16_t)( temp | (uint16_t)(TIM1->PSCRL));
8082  1135 c65261        	ld	a,21089
8083  1138 5f            	clrw	x
...
8093  1143 81            	ret	
8264                     ; 2097 FlagStatus TIM1_GetFlagStatus(TIM1_FLAG_TypeDef TIM1_FLAG)
8264                     ; 2098 {
8265                     	switch	.text
...
8273                     ; 2099     FlagStatus bitstatus = RESET;
8275                     ; 2100     uint8_t tim1_flag_l = 0, tim1_flag_h = 0;
8279                     ; 2103     assert_param(IS_TIM1_GET_FLAG_OK(TIM1_FLAG));
...
8313  1190               L6071:
8314                     ; 2105     tim1_flag_l = (uint8_t)(TIM1->SR1 & (uint8_t)TIM1_FLAG);
8316  1190 c65255        	ld	a,21077
8317  1193 1404          	and	a,(OFST+2,sp)
8318  1195 6b01          	ld	(OFST-1,sp),a
8319                     ; 2106     tim1_flag_h = (uint8_t)((uint16_t)TIM1_FLAG >> 8);
8321  1197 7b03          	ld	a,(OFST+1,sp)
8322  1199 6b02          	ld	(OFST+0,sp),a
8323                     ; 2108     if ((tim1_flag_l | (uint8_t)(TIM1->SR2 & tim1_flag_h)) != 0)
8325  119b c45256        	and	a,21078
8326  119e 1a01          	or	a,(OFST-1,sp)
8327  11a0 2702          	jreq	L1533
8328                     ; 2110         bitstatus = SET;
8330  11a2 a601          	ld	a,#1
8332  11a4               L1533:
8333                     ; 2114         bitstatus = RESET;
8335                     ; 2116     return (FlagStatus)(bitstatus);
8339  11a4 5b04          	addw	sp,#4
8340  11a6 81            	ret	
8376                     ; 2137 void TIM1_ClearFlag(TIM1_FLAG_TypeDef TIM1_FLAG)
8376                     ; 2138 {
8377                     	switch	.text
8378  11a7               _TIM1_ClearFlag:
8380  11a7 89            	pushw	x
8381       00000000      OFST:	set	0
8384                     ; 2140     assert_param(IS_TIM1_CLEAR_FLAG_OK(TIM1_FLAG));
...
8405  11c4               L6171:
8406                     ; 2143     TIM1->SR1 = (uint8_t)(~(uint8_t)(TIM1_FLAG));
8408  11c4 7b02          	ld	a,(OFST+2,sp)
8409  11c6 43            	cpl	a
8410  11c7 c75255        	ld	21077,a
8411                     ; 2144     TIM1->SR2 = (uint8_t)((uint8_t)(~((uint8_t)((uint16_t)TIM1_FLAG >> 8))) & 
8411                     ; 2145                           (uint8_t)0x1E);
...
8420  11d2 85            	popw	x
8421  11d3 81            	ret	
8482                     ; 2162 ITStatus TIM1_GetITStatus(TIM1_IT_TypeDef TIM1_IT)
8482                     ; 2163 {
8483                     	switch	.text
...
8491                     ; 2164     ITStatus bitstatus = RESET;
8493                     ; 2165     uint8_t TIM1_itStatus = 0, TIM1_itEnable = 0;
8497                     ; 2168     assert_param(IS_TIM1_GET_IT_OK(TIM1_IT));
...
8613  1234               L0471:
8614                     ; 2205     TIM1->SR1 = (uint8_t)(~(uint8_t)TIM1_IT);
...
8622  123a 84            	pop	a
8623  123b 81            	ret	
8669                     ; 2224 static void TI1_Config(uint8_t TIM1_ICPolarity,
8669                     ; 2225                        uint8_t TIM1_ICSelection,
8669                     ; 2226                        uint8_t TIM1_ICFilter)
8669                     ; 2227 {
8670                     	switch	.text
8671  123c               L3_TI1_Config:
8673  123c 89            	pushw	x
8674  123d 88            	push	a
8675       00000001      OFST:	set	1
8678                     ; 2230     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1E);
8680  123e 7211525c      	bres	21084,#0
8681                     ; 2233     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF ))) | 
8681                     ; 2234                             (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
8694                     ; 2237     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
8696  1257 7b02          	ld	a,(OFST+1,sp)
8697  1259 2706          	jreq	L3643
8698                     ; 2239         TIM1->CCER1 |= TIM1_CCER1_CC1P;
8700  125b 7212525c      	bset	21084,#1
8702  125f 2004          	jra	L5643
8703  1261               L3643:
8704                     ; 2243         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
8706  1261 7213525c      	bres	21084,#1
8707  1265               L5643:
8708                     ; 2247     TIM1->CCER1 |=  TIM1_CCER1_CC1E;
8710  1265 7210525c      	bset	21084,#0
8711                     ; 2248 }
8714  1269 5b03          	addw	sp,#3
8715  126b 81            	ret	
8761                     ; 2266 static void TI2_Config(uint8_t TIM1_ICPolarity,
8761                     ; 2267                        uint8_t TIM1_ICSelection,
8761                     ; 2268                        uint8_t TIM1_ICFilter)
8761                     ; 2269 {
8762                     	switch	.text
8763  126c               L5_TI2_Config:
8765  126c 89            	pushw	x
8766  126d 88            	push	a
8767       00000001      OFST:	set	1
8770                     ; 2271     TIM1->CCER1 &=  (uint8_t)(~TIM1_CCER1_CC2E);
8772  126e 7219525c      	bres	21084,#4
8773                     ; 2274     TIM1->CCMR2  = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF ))) 
8773                     ; 2275                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
8786                     ; 2277     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
8788  1287 7b02          	ld	a,(OFST+1,sp)
8789  1289 2706          	jreq	L7053
8790                     ; 2279         TIM1->CCER1 |= TIM1_CCER1_CC2P;
8792  128b 721a525c      	bset	21084,#5
8794  128f 2004          	jra	L1153
8795  1291               L7053:
8796                     ; 2283         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
8798  1291 721b525c      	bres	21084,#5
8799  1295               L1153:
8800                     ; 2286     TIM1->CCER1 |=  TIM1_CCER1_CC2E;
8802  1295 7218525c      	bset	21084,#4
8803                     ; 2287 }
8806  1299 5b03          	addw	sp,#3
8807  129b 81            	ret	
8853                     ; 2305 static void TI3_Config(uint8_t TIM1_ICPolarity,
8853                     ; 2306                        uint8_t TIM1_ICSelection,
8853                     ; 2307                        uint8_t TIM1_ICFilter)
8853                     ; 2308 {
8854                     	switch	.text
8855  129c               L7_TI3_Config:
8857  129c 89            	pushw	x
8858  129d 88            	push	a
8859       00000001      OFST:	set	1
8862                     ; 2310     TIM1->CCER2 &=  (uint8_t)(~TIM1_CCER2_CC3E);
8864  129e 7211525d      	bres	21085,#0
8865                     ; 2313     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF))) 
8865                     ; 2314                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
8878                     ; 2317     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
8880  12b7 7b02          	ld	a,(OFST+1,sp)
8881  12b9 2706          	jreq	L3353
8882                     ; 2319         TIM1->CCER2 |= TIM1_CCER2_CC3P;
8884  12bb 7212525d      	bset	21085,#1
8886  12bf 2004          	jra	L5353
8887  12c1               L3353:
8888                     ; 2323         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3P);
8890  12c1 7213525d      	bres	21085,#1
8891  12c5               L5353:
8892                     ; 2326     TIM1->CCER2 |=  TIM1_CCER2_CC3E;
8894  12c5 7210525d      	bset	21085,#0
8895                     ; 2327 }
8898  12c9 5b03          	addw	sp,#3
8899  12cb 81            	ret	
8945                     ; 2346 static void TI4_Config(uint8_t TIM1_ICPolarity,
8945                     ; 2347                        uint8_t TIM1_ICSelection,
8945                     ; 2348                        uint8_t TIM1_ICFilter)
8945                     ; 2349 {
8946                     	switch	.text
8947  12cc               L11_TI4_Config:
8949  12cc 89            	pushw	x
8950  12cd 88            	push	a
8951       00000001      OFST:	set	1
8954                     ; 2352     TIM1->CCER2 &=  (uint8_t)(~TIM1_CCER2_CC4E);
8956  12ce 7219525d      	bres	21085,#4
8957                     ; 2355     TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF )))
8957                     ; 2356                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
8970                     ; 2359     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
8972  12e7 7b02          	ld	a,(OFST+1,sp)
8973  12e9 2706          	jreq	L7553
8974                     ; 2361         TIM1->CCER2 |= TIM1_CCER2_CC4P;
8976  12eb 721a525d      	bset	21085,#5
8978  12ef 2004          	jra	L1653
8979  12f1               L7553:
8980                     ; 2365         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4P);
8982  12f1 721b525d      	bres	21085,#5
8983  12f5               L1653:
8984                     ; 2369     TIM1->CCER2 |=  TIM1_CCER2_CC4E;
...
9080  0000               L37:
9081  0000 6c6962726172  	dc.b	"libraries\src\stm8"
9082  0012 735f74696d31  	dc.b	"s_tim1.c",0
9102                     	end
